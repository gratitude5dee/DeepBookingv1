        ...
        {user ? (
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-6 py-2 rounded-full bg-white/20 text-white font-normal text-xs transition-all duration-300 hover:bg-white/30 cursor-pointer h-8 flex items-center border border-white/30"
            >
              Logout
            </button>
          </div>
